...
class CommentUtilsModeratorTests(CommentTestCase):
    ...
    def createSomeComments(self):
        ...
        try:
            c1 = BogofilterComment.objects.all()[0]
        except IndexError:
            c1 = None
        ...
        try:
            c2 = BogofilterComment.objects.all()[0]
        except IndexError:
            c2 = None
        return c1, c2
    ...
    def testCommentsEnabled(self):
        ...
        self.createSomeComments()
        self.assertEqual(BogofilterComment.objects.all().count(), 1)

    def testAutoCloseField(self):
        moderator.register(Entry, EntryModerator3)
        self.createSomeComments()
        self.assertEqual(BogofilterComment.objects.all().count(), 0)
