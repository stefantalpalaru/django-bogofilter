...
class CommentViewTests(CommentTestCase):
    ...
    def testCreateValidComment(self):
        ...
        self.assertEqual(BogofilterComment.objects.count(), 1)
        c = BogofilterComment.objects.all()[0]
    ...
    def testPostAsAuthenticatedUserWithoutFullname(self):
        ...
        self.response = self.client.post("/post/", data, REMOTE_ADDR="1.2.3.4")
        c = BogofilterComment.objects.get(user=user)
        self.assertEqual(c.ip_address, "1.2.3.4")
    ...
    def testPreventDuplicateComments(self):
        ...
        self.assertEqual(BogofilterComment.objects.count(), 2)
    ...
    def testWillBePostedSignal(self):
        ...
        response = self.client.post("/post/", data)
        self.assertEqual(response.status_code, 400)
        self.assertEqual(BogofilterComment.objects.count(), 0)
    ...
    def testCommentDoneView(self):
        ...
        self.assertEqual(response.context[0]["comment"], BogofilterComment.objects.get(pk=pk))
